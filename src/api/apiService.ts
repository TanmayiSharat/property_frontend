...
export const apiService = {
  ...
  deleteProperty: (id: string): Promise<void> => 
    fetch(`${BASE_URL}/properties/${id}`, { method: 'DELETE' }).then(res => handleResponse<void>(res)),

  // Income
  getIncome: (propertyId: string): Promise<IncomeRecord[]> => 
    fetch(`${BASE_URL}/properties/${propertyId}/income`).then(res => handleResponse<IncomeRecord[]>(res)),

  addIncome: (propertyId: string, data: IncomeFormData): Promise<IncomeRecord> => 
    fetch(`${BASE_URL}/properties/${propertyId}/income`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
  ...
  deleteIncome: (incomeId: string): Promise<void> => 
    fetch(`${BASE_URL}/income/${incomeId}`, { method: 'DELETE' }).then(res => handleResponse<void>(res)),

  // Expenses
  getExpenses: (propertyId: string): Promise<ExpenseRecord[]> => 
    fetch(`${BASE_URL}/properties/${propertyId}/expenses`).then(res => handleResponse<ExpenseRecord[]>(res)),

  addExpense: (propertyId: string, data: ExpenseFormData): Promise<ExpenseRecord> => 
    fetch(`${BASE_URL}/properties/${propertyId}/expenses`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
  ...
  deleteExpense: (expenseId: string): Promise<void> => 
    fetch(`${BASE_URL}/expenses/${expenseId}`, { method: 'DELETE' }).then(res => handleResponse<void>(res)),
};
